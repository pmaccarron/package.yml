...
def setup():
    ...
    shelltools.system("wget https://raw.githubusercontent.com/pmaccarron/package.yml-files/master/multimedia/video/plexmediaserver/files/plexmediaserver.conf")

    shelltools.system("wget https://raw.githubusercontent.com/pmaccarron/package.yml-files/master/multimedia/video/plexmediaserver/files/plexmediaserver.tmpfile")
    shelltools.system("mkdir tmp")
    shelltools.system("mv plexmediaserver.tmpfile tmp/plexmediaserver.conf")

    shelltools.system("wget https://raw.githubusercontent.com/pmaccarron/package.yml-files/master/multimedia/video/plexmediaserver/files/plexmediaserver.service")
